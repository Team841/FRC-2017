...
public class DriveTrain extends Subsystem {
    ...
    private final Solenoid climberRatchet = RobotMap.driveTrainClimberRatchet;
...
*/
    ...
    public void cheesyDrive(Joystick stick) {
		...
		SetLeftRight(0.75*leftPwm,0.75* -rightPwm);
    ...
    public void ClimbRatchedEn(){
    	climberRatchet.set(true);
    }
    public void ClimbRatchedDis(){
    	climberRatchet.set(false);
    }
}
