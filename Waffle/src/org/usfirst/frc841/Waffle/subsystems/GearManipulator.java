...
public class GearManipulator extends Subsystem {
    ...
    private final Solenoid ramp = RobotMap.gearManipulatorRamp;
    private final DigitalInput pegSensor = RobotMap.gearManipulatorPegSensor;
    private final DoubleSolenoid release = RobotMap.gearManipulatorRelease;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new CheckPegAndRelease());
