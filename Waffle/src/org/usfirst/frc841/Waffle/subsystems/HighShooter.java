...
public class HighShooter extends Subsystem {
    ...
    private final GearTooth wheelSpeedSensor = RobotMap.highShooterWheelSpeedSensor;
    private final SpeedController highShooter = RobotMap.highShooterHighShooter;
