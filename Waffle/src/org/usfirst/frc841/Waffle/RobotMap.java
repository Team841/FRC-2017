...
public class RobotMap {
    ...
    public static Solenoid driveTrainShifterSolenoid;
    public static Solenoid driveTrainClimberSolenoid;
    public static Compressor driveTrainCompressor1;
    public static DoubleSolenoid gearManipulatorRamp;
    ...
    public static void init() {
        ...
        driveTrainShifterSolenoid = new Solenoid(0, 3);
        ...
        gearManipulatorRamp = new DoubleSolenoid(0, 0, 1);
        LiveWindow.addActuator("GearManipulator", "Ramp", gearManipulatorRamp);
        
        gearManipulatorRelease = new DoubleSolenoid(0, 2, 4);
        ...
        highShooterHighShooter = new Talon(4);
        LiveWindow.addActuator("HighShooter", "HighShooter", (Talon) highShooterHighShooter);
